      ...
      >
        {!isEditingName ? (
          <div className="calls-view-header">
            ...
            <button className="edit-field edit-button" onClick={this.startEdit}>
              Edit
            </button>
          </div>
        ) : (
  ...
  render() {
    ...
    return (
      <div className="call-container">
          ...
          <div className="call-buttons">
            {!confirmDelete ? (
              <>
                ...
                <button className="call-button" onClick={onClickCallEdit}>
                  Edit
                </button>
              </>
            ) : (
        ...
        <div className="call-content">{content}</div>
      </div>
    )
  }
}
